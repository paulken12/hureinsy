<div class="card">
	...
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col">
				<div class="form-group">
					<input type="text" id="proposed_bonus_allowance" name="proposed_bonus_allowance" class="form-control-plaintext" title="Proposed_bonus/allowance" value="{{$get_compensation_details->proposed_bonus_allowance}}" readonly>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col">
				<div class="form-group">
					<input type="text" id="proposed_benefits" name="proposed_benefits" class="form-control-plaintext" title="Proposed_benefits" value="{{$get_compensation_details->proposed_benefits}}" readonly>
				</div>
			</div>
		</div>
