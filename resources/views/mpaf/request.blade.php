			...
			<div class="row">
				<div class="col">
					<div class="form-group">
						...
						<input type="text" id="date_hired" name="date_hired" class="form-control" title="Date_hired">
					</div>
				</div>
				<div class="col">
					<div class="form-group">
			...
			<div class="row">
				<div class="col">
					<div class="form-group">
						...
						<input type="text" id="position" name="position" class="form-control" title="Position">
					</div>
				</div>
				<div class="col">
					<div class="form-group">
						<label for="department">Department</label>
						<input type="text" id="department" name="department" class="form-control" title="Department">
					</div>
				</div>
			</div>
			<div class="row">
