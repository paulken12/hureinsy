...
@section('content')
    @foreach ($profile->basicInfo as $basicInfo)
        ...
        @can('update',$basicInfo)
            ...
            {{--Address Information--}}
            <div class="accordion" id="address-collapse">
              <div class="card">
                <div class="card-header" id="header-address">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#address" aria-expanded="true" aria-controls="address">
                      Address
                    </button>
                  </h3>
                </div>

                <div id="address" class="collapse" aria-labelledby="header-address" data-parent="#address-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4>Address</h4>
                            <hr>
            ...
            {{--Contact Information--}}
            <div class="accordion" id="contact-collapse">
              <div class="card">
                <div class="card-header" id="header-contact">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#contact-info" aria-expanded="false" aria-controls="contact-info">
                      Contact info
                    </button>
                  </h3>
                </div>

                <div id="contact-info" class="collapse" aria-labelledby="header-contact" data-parent="#contact-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            {{--Benefit Information--}}
            <div class="accordion" id="benefit-collapse">
              <div class="card">
                <div class="card-header" id="header-benefit">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#benefit-info" aria-expanded="false" aria-controls="benefit-info">
                      Benefit info
                    </button>
                  </h3>
                </div>

                <div id="benefit-info" class="collapse" aria-labelledby="header-benefit" data-parent="#benefit-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4>Benefits</h4>
                            <hr>
            ...
            {{--Family Background--}}
            <div class="accordion" id="family-collapse">
              <div class="card">
                <div class="card-header" id="header-family">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#family-background" aria-expanded="false" aria-controls="family-background">
                      Family background
                    </button>
                  </h3>
                </div>

                <div id="family-background" class="collapse" aria-labelledby="header-family" data-parent="#family-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            <div class="accordion" id="education-collapse">
              <div class="card">
                <div class="card-header" id="header-education">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#educational-background" aria-expanded="false" aria-controls="educational-background">
                      Educational background
                    </button>
                  </h3>
                </div>

                <div id="educational-background" class="collapse" aria-labelledby="header-education" data-parent="#education-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            {{--Work Experience--}}
            <div class="accordion" id="work-collapse">
              <div class="card">
                <div class="card-header" id="header-work">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#work-experience" aria-expanded="false" aria-controls="work-experience">
                      Work experience
                    </button>
                  </h3>
                </div>

                <div id="work-experience" class="collapse" aria-labelledby="header-work" data-parent="#work-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            {{--Character Reference--}}
            <div class="accordion" id="character-collapse">
              <div class="card">
                <div class="card-header" id="header-character">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#character-reference" aria-expanded="false" aria-controls="character-reference">
                      Character reference
                    </button>
                  </h3>
                </div>

                <div id="character-reference" class="collapse" aria-labelledby="header-character" data-parent="#character-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            {{--Emergency Contacts--}}
            <div class="accordion" id="emergency-collapse">
              <div class="card">
                <div class="card-header" id="header-emergency">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#emergency-contacts" aria-expanded="false" aria-controls="emergency-contacts">
                      Emergency contact
                    </button>
                  </h3>
                </div>

                <div id="emergency-contacts" class="collapse" aria-labelledby="header-emergency" data-parent="#emergency-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            {{--Medical Information--}}
            <div class="accordion" id="medical-collapse">
              <div class="card">
                <div class="card-header" id="header-medical">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#medical-info" aria-expanded="false" aria-controls="medical-info">
                      Medical info
                    </button>
                  </h3>
                </div>

                <div id="medical-info" class="collapse" aria-labelledby="header-medical" data-parent="#medical-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
            ...
            {{--Skills--}}
            <div class="accordion" id="skills-collapse">
              <div class="card">
                <div class="card-header" id="header-skills">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#skill" aria-expanded="false" aria-controls="skill">
                      Skills
                    </button>
                  </h3>
                </div>

                <div id="skill" class="collapse" aria-labelledby="header-skills" data-parent="#skills-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4>Skill Set</h4>
                            <hr>
            ...
            {{--Trainings--}}
            <div class="accordion" id="trainings-collapse">
              <div class="card">
            ...
            @can('update', $basicInfo)
            {{--Conviction--}}
            <div class="accordion" id="conviction-collapse">
              <div class="card">
                <div class="card-header" id="header-conviction">
                  <h3 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#conviction" aria-expanded="false" aria-controls="conviction">
                      Conviction
                    </button>
                  </h3>
                </div>

                <div id="conviction" class="collapse" aria-labelledby="header-conviction" data-parent="#conviction-collapse">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4>Conviction</h4>
                            <hr>
